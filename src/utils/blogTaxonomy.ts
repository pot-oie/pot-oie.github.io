...
export const TECH_CATEGORY_META_LIST: TechCategoryMeta[] = [
  {
    key: "frontend",
    label: "前端",
    englishLabel: "Frontend",
    description: "Interfaces, interactions, and the craft behind them.",
    slug: "frontend",
  ...
  },
  {
    key: "backend",
    label: "后端",
    englishLabel: "Backend",
    description: "Systems, protocols, and what runs beneath.",
    slug: "backend",
  ...
  },
  {
    ...
    label: "智能",
    englishLabel: "AI",
    description: "Models, methods, and the boundaries of intelligence.",
    slug: "ai",
  ...
  },
  {
    key: "leetcode",
    label: "题解",
    englishLabel: "Algorithms",
    description: "Patterns, invariants, and precise reasoning.",
    slug: "leetcode",
  ...
  },
  {
    ...
    description: "Concepts revisited and made clear.",
    slug: "classroom",
...
export const LIFE_CATEGORY_META_LIST: LifeCategoryMeta[] = [
  {
    ...
    label: "日常",
    englishLabel: "Daily",
    description: "Small moments and passing thoughts.",
    slug: "daily",
  ...
  },
  {
    ...
    label: "专辑",
    englishLabel: "Albums",
    description: "Albums heard closely, remembered beyond the final track.",
    slug: "album",
  ...
  },
  {
    ...
    label: "影评",
    englishLabel: "Cinema",
    description: "Films revisited after the screen goes dark.",
    slug: "movie",
