...
6. AI architecture abbreviations such as `CNN`, `GNN`, `RNN`, `LSTM`, and `GRU` can stay in English, while article-specific mechanisms should prefer concise Chinese tags such as `卷积`, `消息传递`, or `聚合函数`.
