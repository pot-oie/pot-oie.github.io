...
4. `styling.md`: understand the visual system and global style constraints.
5. `components.md`: understand the UI component groups and ownership boundaries.
6. `interaction.md`: understand global events, storage keys, and page-transition behavior.
7. `scripts.md`: understand local automation and content creation scripts.
8. `deployment.md`: understand the build and deployment path.
9. `modules/*/overview.md`: understand each content module in more detail.
